...
class LanguageChanger(QLabel):
    ...
    def update_ui(self):
        try:
            ...
            self._main_window.store_name_input.setPlaceholderText(Language.get("store") + str(len(STORES) + 1))

            self._main_window.shortcut_category.update_category_button.setText(Language.get("save"))
            self._main_window.shortcut_category.create_category_button.setText(Language.get("create"))
            self._main_window.shortcut_category.stop_editting_category.setText(Language.get("go_back"))
            self._main_window.shortcut_category.add_category_button.setText(Language.get("add_category"))
            self._main_window.shortcut_category.cancel_add_category_button.setText(Language.get("cancel"))
            self._main_window.shortcut_category.input_new_category_name.setPlaceholderText(Language.get("name"))
            self._main_window.shortcut_category.new_category_color_selector.setText(Language.get("select_color"))
            self._main_window.shortcut_category.edit_category_color_selector.setText(Language.get("select_color"))
            self._main_window.shortcut_category.label_input_edit_category_name.setText(Language.get("category_name"))
            self._main_window.shortcut_category.label_input_edit_category_color.setText(Language.get("category_color"))
            ...
            for storage in SHELVES:
                for shelf in storage:
                    ...
                    for space in shelf.spaces:
                        ...
                        space.category.label_input_edit_category_color.setText(Language.get("category_color"))
